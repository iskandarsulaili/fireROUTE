...
|---|---|---|---|
| GET | `/similar` | required `q`, `type`, `k`; optional `info`, `limit`, `slimit` | Returns recommendation results for music and other content/entity types. |
...
- Although this file sits in the Music category, the same endpoint supports non-music types too.
