...
- Provider slug: `sport-vision`
- Official docs/pages attempted:
  - `https://developers.decathlon.com/products/sport-vision` (official product page from the category index)
...
- whether API-key auth is still required on the live official docs
