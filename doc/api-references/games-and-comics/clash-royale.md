...
## Overview
- Provider: `Clash Royale API`
- Category: `Games & Comics`
- Official landing page reviewed in this execution: `https://developer.clashroyale.com/`
- Official getting-started page reviewed in this execution: `https://developer.clashroyale.com/#/getting-started`
- Official documentation route reviewed in this execution: `https://developer.clashroyale.com/#/documentation`
- Official alternative page reviewed in this execution: `https://developer.clashroyale.com/api-docs/index.html`
- Manual status: `manual_blocked`
- Confirmed route count: `0`

## Manual official-site findings
- The public getting-started page loaded as `Clash Royale API`.
...
- The public getting-started page said the token is bound to rate limitations and specified IP addresses, and that the API enforces those restrictions.
- The public getting-started page said all API responses are JSON-formatted documents with UTF-8 encoded content.
...
- The reviewed Swagger shell source still referenced `game-api-url` and `game-api-token`, confirming that the docs shell expects authenticated developer-session state before it can load the underlying API definition.

## Confirmed fireROUTE integration facts
- Official developer portal host: `https://developer.clashroyale.com`
...
- Important usage note: the public site exposes onboarding guidance, but the actual endpoint inventory remains hidden behind authenticated developer-session state
...
- `https://developer.clashroyale.com/api-docs/index.html`
